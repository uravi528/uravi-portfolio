...
export function AboutSection() {
  return (
    <div id="about" className="max-w-5xl mx-auto px-4 sm:px-8 py-14 sm:py-20 space-y-20 scroll-mt-20">
      ...
      {/* Stats */}
      <div className="grid sm:grid-cols-2 gap-10 border-t border-line pt-10">
        {stats.map((s, i) => (
          <motion.div
            key={s.label}
            initial={{ opacity: 0, y: 16 }}
          ...
          >
            <p className="font-hero text-6xl sm:text-7xl text-ink">{s.value}</p>
